...
class Bootstrap4DisclosureMenu extends DisclosureMenu {
  constructor(_ref) {
    ...
    _defineProperty(this, "_MenuType", Bootstrap4DisclosureMenu);
    _defineProperty(this, "_MenuItemType", Bootstrap4DisclosureMenuItem);
    _defineProperty(this, "_MenuToggleType", Bootstrap4DisclosureMenuToggle);
    if (initialize) {
      this.initialize();
    }
  }
