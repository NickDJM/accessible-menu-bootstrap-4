...
class Bootstrap4Menubar extends Menubar {
  constructor(_ref) {
    ...
    _defineProperty(this, "_MenuType", Bootstrap4Menubar);
    _defineProperty(this, "_MenuItemType", Bootstrap4MenubarItem);
    _defineProperty(this, "_MenuToggleType", Bootstrap4MenubarToggle);
    if (initialize) {
      this.initialize();
    }
  }
