/**
 * Test the Bootstrap4DisclosureMenu class to make sure it functions correctly.
 *
...
openClose(Bootstrap4DisclosureMenu);
clickTests(Bootstrap4DisclosureMenu);
hoverTests(Bootstrap4DisclosureMenu);
baseKeypressTests(Bootstrap4DisclosureMenu);

describe("Bootstrap4DisclosureMenu keypress tests", () => {
...
describe("Bootstrap4DisclosureMenu optional keypress tests", () => {
...
describe("Bootstrap4DisclosureMenu submenu keypress tests", () => {
  describe("'Escape' key", () => {
    const key = "Escape";
