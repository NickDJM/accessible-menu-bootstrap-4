...
export function aria(MenuClass) {
  ...
  describe(`${menuType}`, () => {
    ...
    const expectedItemRole =
      menuType === "Bootstrap4Menubar" ? "menuitem" : "treeitem";
    const submenus = [
      { index: 0, id: 2 },
      { index: 1, id: 3 },
      { index: 2, id: 5 },
    ...
    if (menuType === "Bootstrap4Menubar" || menuType === "Bootstrap4Treeview") {
    ...
    describe.each(submenus)("submenu $index", ({ index, id }) => {
      ...
      if (
        menuType === "Bootstrap4Menubar" ||
        menuType === "Bootstrap4Treeview"
      ) {
