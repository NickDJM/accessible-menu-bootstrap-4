/**
 * Test the Bootstrap4Treeview class to make sure it functions correctly.
 *
...
openClose(Bootstrap4Treeview);
clickTests(Bootstrap4Treeview);
hoverTests(Bootstrap4Treeview);
baseKeypressTests(Bootstrap4Treeview);

describe("Bootstrap4Treeview keypress tests", () => {
